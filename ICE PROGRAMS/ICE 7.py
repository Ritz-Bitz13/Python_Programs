...
while valid == False:
    ...
    if not numeric:
        print(f"ERROR - Please enter between {MIN_NUMBER} and {MAX_NUMBER}")
...
for count in range(number, MIN_NUMBER, -1): #First number is the number given from user, second is where you're counting to, third is saying how you count to the number
    output = count*output
